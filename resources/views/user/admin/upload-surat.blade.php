...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <h1 class="h3 mb-0 text-gray-800">Upload Surat</h1>
    ...
    <div class="row">
        ...
        <div>
            ...
            <form class="row gx-4 gx-lg-5 justify-content-center mb-5" 
                action="{{ route('admin.upload-surat-store') }}" method="POST" enctype="multipart/form-data">
            @csrf   
            ...
            <div class="col-lg-12">
                <div class="mb-3">
                    ...
                    <select name="tipe_surat" id="tipe_surat" 
                        ...
                        <option value="Surat Masuk" {{ old('tipe_surat') === 'Surat Masuk' ? 'selected' : '' }}>Surat Masuk</option>
                        <option value="Surat Keluar" {{ old('tipe_surat') === 'Surat Keluar' ? 'selected' : '' }}>Surat Keluar</option>
                    </select>
                    @error('tipe_surat')
