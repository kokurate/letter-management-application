            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <table id="admin_surat_masuk" class="table hover table-bordered table-striped cell-border" style="width:100%">
                        ...
                        <tbody>
                            @foreach(App\Models\Surat::where('tipe_surat', 'Surat Masuk')->orderBy('created_at', 'asc')->get() as $data)
                                <tr>
                                    ...
                                    <td class="text-center">  
                                        ...
                                        <a href="#" class="my-1 px-1 py-1 btn btn-danger btn-sm delete" id="{{ $data->id }}"
                                        ...
                                        <a href="{{ route('admin.surat-masuk-edit', $data->id) }}" class="my-1 px-1 py-1 btn btn-primary btn-sm delete">
